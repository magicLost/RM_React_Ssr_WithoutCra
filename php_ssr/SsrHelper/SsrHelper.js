...
var SsrHelper = /** @class */ (function () {
    function SsrHelper() {
        ...
        this.copyAssetManifest = function (pathToCraAssetManifestFile, pathToPhpAssetManifestFile) {
            ...
            fs.writeFile(pathToPhpAssetManifestFile, JSON.stringify(cra_manifest), "utf-8", function (err) {
                if (err)
                    throw err;
        ...
        this.lastSteps = function (pathToPhpStaticDir, pathToCraStaticDir, pathToCraRenderedPagesDir, pathToPhpTemplatesDir, pathToCraAssetManifestFile, pathToPhpAssetManifestFile) { return __awaiter(_this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        //copy manifest file
                        this.copyAssetManifest(pathToCraAssetManifestFile, pathToPhpAssetManifestFile);
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _a.sent();
